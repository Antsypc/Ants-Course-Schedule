              ...
              <div class="tab-content">
                <div class="active tab-pane" id="addSchedule">
                  <div class="schedule-content">
                    ...
                    <div class="cardimg">
                      <img class="schedule-img profile-user-img img-responsive img-circle" src="<%=request.getContextPath()%>/assets/vendor/AdminLTE/dist/img/avatar.png">
                    </div>
                      ...
                      <table class="table table-bordered table-striped">
                        ...
                        <c:forEach items="${courses }" var="courses">
                          <tr data-text="${courses.description }">
                            ...
                            <td>第${courses.weekFrom }-${courses.weekTo}周,星期${courses.weekday },${courses.timeFrom }-${courses.timeTo }</td>
                      ...
                      <div class="modal-content">
                        <div class="modal-header bg-aqua-active">
                          ...
                          <div class="modalCardimg">
                            <img class="profile-user-img img-responsive img-circle" src="<%=request.getContextPath()%>/assets/vendor/AdminLTE/dist/img/avatar.png">
                          </div>
                        </div>
        ...
        if (courseName != "" && courseClass != "") {
          ...
          $.ajax({
            ...
            success : function(data) {
                if(data.success == 'false') {sweetAlert('系统提示', '课程计划提交失败，请重新操作！', 'error'); return;}
            	sweetAlert({
            		title: '系统提示',
            		text: '课程计划提交成功！',
            		type: 'success'
