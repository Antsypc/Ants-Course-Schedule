            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  ...
                  <p>
                    ${requestScope.user.name } - 管理员<small>登录时间: <%=now %></small></p>
                </li>
                <!-- Menu Footer-->
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              ...
              <ul class="treeview-menu">
                <li>
                  <a href="<%=request.getContextPath()%>/lab/manage/search">
                    <i class="fa fa-circle-o"></i>
                    <span>实验室查询</span>
                  </a>
                </li>
                <li>
                  <a href="<%=request.getContextPath()%>/lab/review">
                    <i class="fa fa-circle-o"></i>
                    <span>实验室预约申请审核</span>
                  </a>
                </li>
            ...
            <li>
              ...
              <ul class="treeview-menu">
                <li>
                  <a href="<%=request.getContextPath()%>/equipment/equipment">
                    <i class="fa fa-circle-o"></i>
                    <span>设备管理</span>
                  </a>
                </li>
                <li>
                  <a href="<%=request.getContextPath()%>/equipment/repair">
                    <i class="fa fa-circle-o"></i>
                    <span>设备维修管理</span>
                  </a>
                </li>
                <li>
                  <a href="<%=request.getContextPath()%>/equipment/consumables">
                    <i class="fa fa-circle-o"></i>
                    <span>耗材管理</span>
                  </a>
                </li>
      ...
      <div class="tab-content">
        <div class="active tab-pane" id="essentialInfo">
          <div class="box-body box-profile">
            <img class="profile-user-img img-responsive img-circle" src="<%=request.getContextPath()%>/assets/img/manager.png" alt="User profile picture">
            <h3 class="profile-username text-center">${requestScope.user.name }</h3>
            <p class="text-muted text-center">${requestScope.user.position }</p>
            <ul class="list-group list-group-unbordered">
              <li class="list-group-item">
                <b>员工编号</b> <a class="pull-right">${requestScope.user.id }</a>
              </li>
              <li class="list-group-item">
                <b>职位</b> <a class="pull-right">${requestScope.user.position }</a>
              </li>
              <li class="list-group-item">
